...
<body>
	...
	<p>
		...
		=> 즉, JSP의 가장 큰 장점은 Servlet에서는 요청처리(비지니스 로직)에만 집중하고 <br>
		   응답화면을 만들어 내는건 JSP에서 집중하게끔 분리할 수 있는 것
	</p>
	...
	<p>JSP페이지 전체에 영향을 미치는 정보를 기술할 때 사용</p>
	...
	<ol>
		<li>
			...
			- pageEncoding :  jsp페이지내에 기독된 자바코드의 인코딩 방식 지정 <br>
		...
		<li>
			include 지시어 : 현재 jsp상에 또다른 jsp를 포함시키고자 할 때 사용하는 지시어 <br>
	...
	<h2>피자주문페이지(JSP) --주문요청(View)--> 주문요청을 받아서 처리해주는 Servlet(Controller) --> 피자결제페이지(응답JSP) </h2>
	<a href="views/pizzaOrederForm.jsp">피자 주문 페이지</a>
